...
If you wish to implement the **[ConnectedDevicesAccountManager](/java/api/com.microsoft.connecteddevices.connecteddevicesaccountmanager)** interface yourself, take note of the following information: 
